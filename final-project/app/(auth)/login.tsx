      ...
      <LinearGradient colors={["#6e45e2", "#88d3ce"]} style={styles.background}>
        <ThemedView style={styles.loginContainer}>
          ...
          <View style={styles.socialContainer}>
            ...
            <TouchableOpacity style={styles.socialButton}>
              <FontAwesome name="instagram" size={20} color="#dd2a7b" />
          ...
          <Text style={styles.signUpText}>
            ...
            <Link href="/signup">
            <TouchableOpacity onPress={()=> router.replace('/signup')}><Text style={styles.signUpLink}>Sign up</Text></TouchableOpacity>
